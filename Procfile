...
locust-master: /bin/bash -c "exec /usr/local/bin/locust -f ${LOCUSTFILE_NAME}.py --master"
locust-follower: /bin/bash -c "exec /usr/local/bin/locust -f ${LOCUSTFILE_NAME}.py --worker --master-host=$(<.masterIP)"