...
locust-master: /bin/bash -c "exec /usr/local/bin/locust -f locustfile_search_list.py --master"
locust-follower: /bin/bash -c "exec /usr/local/bin/locust -f locustfile_search_list.py --worker --master-host=$(<.masterIP)"