...
locust-master: /bin/bash -c "exec /usr/local/bin/locust -f locustfile_redis_search.py --master"
locust-follower: /bin/bash -c "exec /usr/local/bin/locust -f locustfile_redis_search.py --worker --master-host=$(<.masterIP)"