...
locust-master: /bin/bash -c "exec /usr/local/bin/locust -f locustfile_vanila_node.py --master"
locust-follower: /bin/bash -c "exec /usr/local/bin/locust -f locustfile_vanila_node.py --worker --master-host=$(<.masterIP)"