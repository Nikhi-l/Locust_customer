...
locust-master: /bin/bash -c "exec /usr/local/bin/locust -f locustfile_blank.py --master"
locust-follower: /bin/bash -c "exec /usr/local/bin/locust -f locustfile_blank.py --worker --master-host=$(<.masterIP)"